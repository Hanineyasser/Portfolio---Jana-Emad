...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Elexandria,Egypt",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "ganaemad126@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+201284991198",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm available for freelance, part-time or full-time work. Drop me a line if you have a
